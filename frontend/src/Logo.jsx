export default function Logo({ width = 120, height = 120, className = '', hideText = false, style = {}, pillarColor = '#000000' }) {
  return (
    <svg 
      width={width} 
      height={height} 
    ...
    >
      ...
      {/* Center Pillar */}
      <path d="M100 15 L130 30 V160 L100 145 Z" fill={pillarColor}/>
      
      {/* Left Pillar */}
      <path d="M55 45 L85 60 V130 L55 115 Z" fill={pillarColor}/>
      
      {/* Right Pillar */}
      <path d="M145 45 L175 60 V130 L145 115 Z" fill={pillarColor}/>
